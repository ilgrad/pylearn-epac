...
#def dumps_class_defintion(obj, attr_depth=1):
#    """
#from epac.utils import dumps_class_defintion
#from epac.utils import get_next_number
#import dill as pickle
#
#class A:
#    def __init__(self):
...
#
#
#C_cp = pickle.loads(dump_str)
#C_cp.test()
#
#
#dump_str = dumps_class_defintion(B(), 2)
#num, _ = get_next_number(dump_str)
#f = open("/tmp/dump_str", "wb")
#f.write(dump_str)
#f.close()
#
...
#    dump_str = repr(len(obj_str)) + " " + obj_str
#    next_attr_depth = attr_depth - 1
#    if next_attr_depth > 0:
#        members = \
#            [attr for attr in dir(obj)\
#                if not callable(attr) and not attr.startswith("__")]
#        dump_str = dump_str + " " + repr(len(members))
#        for attr in members:
#            print attr
#            attr_str = dumps_class_defintion(getattr(obj, attr), next_attr_depth)
#            dump_str = dump_str + " " + repr(len(attr_str)) + " " + attr_str
#    else:
#        dump_str = dump_str + " 0"
#    return dump_str
#
#
#def loads_class_defintion(dump_str):
#    """
#import dill as pickle
#from epac.utils import get_next_number
#f = open("/tmp/dump_str", "rb")
...
#f.close()
#
#length, left_dump_str = get_next_number(dump_str)
#type(length)
#type(left_dump_str)
#obj = pickle.loads(left_dump_str[0: length])
#obj.test()
#obj.a.a
#obj.a.b
#obj.a.test()
